...
echo -e "${MAGENTA}3. View miner logs: sudo journalctl -u iniminer.service --no-pager --lines=50${RESET}"
echo -e "${MAGENTA}4. Check your mining progress at: ${POOL_URL}#/account/$WALLET_ADDRESS${RESET}"
